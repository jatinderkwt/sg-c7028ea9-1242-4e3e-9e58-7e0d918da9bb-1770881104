...
import { LayoutDashboard, Users, Building, LogOut, Settings, CreditCard, Shield, Activity } from 'lucide-react'
        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="w-64 bg-gray-900 text-white flex flex-col shadow-lg">
                ...
                <nav className="flex-1 px-2 space-y-1 overflow-y-auto">
                    <div className="mb-4">
                        <Link href="/admin" className="flex items-center gap-3 px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition group">
                    ...
                    <Link href="/admin/companies" className="flex items-center gap-3 px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition group">
                        <Building size={18} className="group-hover:text-blue-400" />
                        Tenant Registry
                    </Link>
                    <Link href="/admin/users" className="flex items-center gap-3 px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition group">
                        <Users size={18} className="group-hover:text-blue-400" />
                        User Base
                    </Link>
                    ...
                    <Link href="/admin/waba" className="flex items-center gap-3 px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition group">
                        <Settings size={18} className="group-hover:text-blue-400" />
                        WABA Engine
                    </Link>
                    <Link href="/admin/billing" className="flex items-center gap-3 px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition group">
                    ...
                    <Link href="/admin/governance" className="flex items-center gap-3 px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition group">
